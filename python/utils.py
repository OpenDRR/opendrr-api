...
class PostGISdataset: #(self, view): 
    """A class to represent a dataset stored in PostGIS with methods to connect to 
    a PostGIS database, query the table into a geojson object and post that geojson 
