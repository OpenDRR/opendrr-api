...
get_model_factory_scripts() {
  ...
  # curl -L -o model-factory.tar.gz https://github.com/OpenDRR/model-factory/archive/refs/tags/v1.4.1.tar.gz
  # tar -xf model-factory.tar.gz
  RUN git clone https://github.com/OpenDRR/model-factory.git --branch updates_may2022 --depth 1 || (cd model-factory ; RUN git pull)
  ...
  # RUN cp model-factory-1.4.1/scripts/*.* .
