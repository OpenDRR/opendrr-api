...
# get boundary files
curl -# -O https://media.githubusercontent.com/media/OpenDRR/boundaries/master/opendrr-boundaries.sql
...
pg_restore -h db-opendrr -U ${POSTGRES_USER} -d ${DB_NAME} opendrr-boundaries.sql
