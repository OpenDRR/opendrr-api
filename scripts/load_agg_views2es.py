...
for eqScenario in ['sim6p8_cr2022_rlz_1']:
    for retrofitPrefix in ['b0','r1','r2']:
        ...
        'social_disruption_agg_view']:
            ...
            os.system('python3 postgres2es.py --eqScenario={eqScenario} --retrofitPrefix={retrofitPrefix} --dbview={view} --idField="Sauid"'.format(**{'eqScenario':eqScenario, 'retrofitPrefix':retrofitPrefix, 'view':view}))